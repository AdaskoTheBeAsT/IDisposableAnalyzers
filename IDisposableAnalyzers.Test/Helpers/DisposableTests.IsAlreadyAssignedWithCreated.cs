...
namespace N
{
    ...
    public class Disposable : IDisposable
    {
        public void Dispose()
        {
            ...
            Assert.That(Disposable.IsAlreadyAssignedWithCreated(value, semanticModel, CancellationToken.None, out _), Is.False);
        }
...
namespace N
{
    ...
    public class Disposable : IDisposable
    {
        public void Dispose()
        {
            ...
            Assert.That(Disposable.IsAlreadyAssignedWithCreated(value, semanticModel, CancellationToken.None, out _), Is.True);
        }
